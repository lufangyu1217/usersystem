...
class UserBasic extends Migration
{
    ...
    public function up()
    {
        ...
        $table->addColumn('hasSick', 'string', array('default' => '无', 'comment' => '有无疾病史'));
        $table->addColumn('serviceTime', 'integer', array('comment' => '希望服务年限(年)'));
        $table->addColumn('expectedSalary', 'integer', array('comment' => '期望月薪'));
